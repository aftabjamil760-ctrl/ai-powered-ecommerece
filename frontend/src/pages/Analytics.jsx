    ...
    return (
        <div className="min-h-screen bg-[#0f172a] text-gray-100 p-4 md:p-8 font-sans">
            <header className="mb-10 flex flex-col md:flex-row justify-between items-center gap-6">
                <div>
                    <h1 className="text-4xl font-extrabold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Business Intelligence</h1>
                    <p className="text-gray-400 mt-2">Real-time performance and customer insights dashboard</p>
                </div>
